...
It is explicitly stated in the abstract that \cite{10.1093/iwc/iwv003} uses an "\textbf{Exploratory Mixed Method}" research design. Mixed method designs could have different types and variants, one of which is "\textbf{Mixed Method Experimental (Intervention)}"\cite{creswell2018research}. It involves the researcher collecting and analyzing both quantitative and qualitative data and integrating the information within an experiment or intervention trial. We can clearly see this pattern within this study. \textcolor{red}{The quantitative comparison of different designs 
 .... RAMBLE RAMBLE}.
