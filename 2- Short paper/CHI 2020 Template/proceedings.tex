...
\begin{abstract}
  The goal of this document is to  identify and analyze the methodological approaches, research designs, data collection and analysis methods of \cite{10.1093/iwc/iwv003} in less than 1600 words. In this text we show that the aforementioned paper uses a pragmatic world view which is well in line with the goal of the study. It also adopts a mixed method research design with an exploratory, comparative methodology which uses between-subject experiments, interviews and open ended questions as means of data collection. It initially uses a deductive/going in theory and later develops new usages in form of inductive/going out. We briefly discuss its selection of participants and possible generalization as unresolved threats and testing as one that was properly addressed. We also talk about a possible power relationship as an ethical issue in the study. we discuss the rationale behind choosing the designs, methodologies and data collection methods. In the end we acknowledge that the knowledge claims fit this particular choice of approach and offer a purely quantitative study as a possible alternative to this mixed method research. 
\end{abstract}
